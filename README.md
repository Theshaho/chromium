...
* `shm_size`: is the shared memory size and set it to a almost high volume, for example of your VPS ram is 16 you can set it to 10gb for a smooth run
```
---
services:
  chromium:
    ...
    environment:
      ...
      - PGID=1000
      - TZ=Europe/London
      - CHROME_CLI=https://github.com/TheShaho #optional
    volumes:
